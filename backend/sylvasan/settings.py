...
DSF_OAUTH2_CLIENT_ID = env("DSF_OAUTH2_CLIENT_ID")
DSF_OAUTH2_PORTAIL_URL = env("DSF_OAUTH2_PORTAIL_URL")
DSF_OAUTH2_REDIRECT_APP_URI = env("DSF_OAUTH2_REDIRECT_APP_URI")
DSF_OAUTH2_REDIRECT_WEB_URI = env("DSF_OAUTH2_REDIRECT_WEB_URI")
DSF_OAUTH2_CLIENT_SECRET = env("DSF_OAUTH2_CLIENT_SECRET")
DSF_OAUTH2_WEB_SUCCESS_REDIRECT_ROOT = env("DSF_OAUTH2_WEB_SUCCESS_REDIRECT_ROOT")
